  ...
  - name: "bcrypt"
    version_range: "^4.0.0"`}
                ...
                <div className="space-y-4 pl-6 pt-2 pb-4">
                  <p className="text-sm text-gray-300 font-semibold uppercase tracking-wider flex items-center gap-1.5">
                    <Code className="w-4 h-4 text-blue-400" />
                    build.yaml Field Definitions
                  </p>
                  <div className="space-y-4">
                    <div className="p-4 bg-black/20 rounded-xl border border-[#1e293b] space-y-2">
                      <strong className="text-sm font-bold text-white block">A. metadata (Required)</strong>
                      ...
                      <ul className="list-disc list-inside text-sm text-gray-400 pl-4 space-y-1">
                        <li><code className="text-blue-400">name</code> (String, Required): The catalog name of the compiled artifact.</li>
                        <li><code className="text-blue-400">versionScheme</code> (String, Optional): The Semantic Versioning parser format to use.</li>
                      </ul>
                    </div>

                    <div className="p-4 bg-black/20 rounded-xl border border-[#1e293b] space-y-2">
                      <strong className="text-sm font-bold text-white block">B. build (Required)</strong>
                      <p className="text-sm text-gray-400 leading-relaxed pl-2">
                        Defines runtime resource limits and execution context parameters.
                      </p>
                      <ul className="list-disc list-inside text-sm text-gray-400 pl-4 space-y-1">
                        <li><code className="text-blue-400">image</code> (String, Required): Docker image name utilized as the isolated build container.</li>
                        <li><code className="text-blue-400">timeoutSeconds</code> (Integer, Optional): Run duration boundary before execution aborts (default: 1800).</li>
                        <li><code className="text-blue-400">memory</code> (String, Optional): Ram allocation boundaries assigned to the builder container (e.g. <code>2g</code>, <code>4g</code>).</li>
                        <li><code className="text-blue-400">cpus</code> (Integer, Optional): Number of core processors allocated for the Docker builder.</li>
                      </ul>
                    </div>

                    <div className="p-4 bg-black/20 rounded-xl border border-[#1e293b] space-y-2">
                      <strong className="text-sm font-bold text-white block">C. steps (Required)</strong>
                      <p className="text-sm text-gray-400 leading-relaxed pl-2">
                        The shell scripts to execute inside the build container workspace.
                      </p>
                      <ul className="list-disc list-inside text-sm text-gray-400 pl-4 space-y-1">
                        <li><code className="text-blue-400">setup</code> (String, Optional): Installs prerequisites, setups configurations, or fetches tools.</li>
                        <li><code className="text-blue-400">build</code> (String, Required): The compile command compiling the codebase (e.g., <code>mvn clean package</code>, <code>npm run build</code>).</li>
                        <li><code className="text-blue-400">test</code> (String, Optional): Test execution scripts.</li>
                      </ul>
                    </div>

                    <div className="p-4 bg-black/20 rounded-xl border border-[#1e293b] space-y-2">
                      <strong className="text-sm font-bold text-white block">D. artifacts (Required)</strong>
                      <p className="text-sm text-gray-400 leading-relaxed pl-2">
                        Specifies which files generated by the compile commands should be collected.
                      </p>
                      <ul className="list-disc list-inside text-sm text-gray-400 pl-4 space-y-1">
                        <li><code className="text-blue-400">pattern</code> (String, Required): Filesystem glob pattern matching compiled files inside workspace (e.g. <code>target/*.jar</code>, <code>dist/*.tgz</code>).</li>
                        <li><code className="text-blue-400">type</code> (String, Optional): Registry catalog artifact packaging class (e.g., <code>jar</code>, <code>war</code>, <code>tgz</code>).</li>
                      </ul>
                    </div>

                    <div className="p-4 bg-black/20 rounded-xl border border-[#1e293b] space-y-2">
                      <strong className="text-sm font-bold text-white block">E. dependencies (Optional)</strong>
                      <p className="text-sm text-gray-400 leading-relaxed pl-2">
                        Defines requirements on other artifacts in the platform.
                      </p>
                      <ul className="list-disc list-inside text-sm text-gray-400 pl-4 space-y-1">
                        <li><code className="text-blue-400">name</code> (String, Required): Dependency artifact catalog identifier.</li>
                        <li><code className="text-blue-400">version_range</code> / <code className="text-blue-400">versionRange</code> (String, Required): Target SemVer range filters (e.g. <code>^4.0.0</code>, <code>&gt;=1.2.0</code>).</li>
                        <li><code className="text-blue-400">optional</code> (Boolean, Optional): If set true, prevents failing builds if missing.</li>
                      </ul>
                    </div>
                  </div>
                </div>
